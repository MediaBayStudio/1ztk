...
function create_images() {
  ...
  // if ( $_POST['380'] ) {
  //   $filepath_large = $upload_dir . $img_filename . '.380.jpg';
  //   $img_large_basename = $img_filename . '.380.jpg';

  //   if ( file_exists( $filepath_large ) ) {
  //     delete_field( '380', $img_id );
  ...
  //     update_field( '380', $filepath_large_end_url, $img_id );

  //     compressImage( $filepath_large, $filepath_large );
  //   }
  // }

  // if ( $_POST['380_webp'] && file_exists( $filepath_large ) ) {
  //   delete_field( '380_webp', $img_id );
  ...
  //   update_field( '380_webp', $webp_large_end_url, $img_id );
  // }
